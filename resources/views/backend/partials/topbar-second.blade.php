                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-0">
                    <div>
                        ...
                        <div class="border-dashed border-top mb-4 pt-4 px-6">
                            ...
                            <a href="{{ route('logout') }}" class="text-secondary d-flex align-items-center gap-2"
            ...
            <div data-simplebar="" style="height: 800px">
                <div class="list-group list-group-flush">
                    ...
                    <a href="#" class="list-group-item list-group-item-action p-5 border-dashed border-bottom">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex gap-4 align-items-center">
                                <img src="{{ asset('backend/assets/images/avatar/avatar-2.jpg') }}" alt=""
                                    class="avatar avatar-md rounded-circle" />
                                <div class="d-flex flex-column gap-1">
                    ...
                    <a href="#" class="list-group-item list-group-item-action p-5 border-dashed border-bottom">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex gap-4 align-items-center">
                                <img src="{{ asset('backend/assets/images/avatar/avatar-3.jpg') }}" alt=""
                                    class="avatar avatar-md rounded-circle" />
                                <div class="d-flex flex-column gap-1">
